  ...
  v-if="weatherData"
    ...
    <div class="flex flex-col items-center text-white p-12">
      ...
      <p class="text-8xl mb-8">
        {{
          (((Math.round(weatherData.current.temp) - 32) * 5) / 9).toFixed(0)
        }}&deg;
      </p>
      ...
      <p>
        Feels like
        {{
          (((Math.round(weatherData.current.feels_like) - 32) * 5) / 9).toFixed(
            0
          )
        }}&deg;
      </p>
      ...
      <div class="mx-8 text-white">
        ...
        <div
          class="
            ...
            scrollbar
            scrollbar-thin
            scrollbar-corner-weather-secondary
        ...
        >
          ...
          >
            ...
            <img
              class="w-auto h-[60px] object-cover"
              :src="`http://openweathermap.org/img/wn/${hourData.weather[0].icon}@2x.png`"
              alt=""
            />
            <p class="text-xl mb-4">
              {{ (((Math.round(hourData.temp) - 32) * 5) / 9).toFixed(0) }}&deg;
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mx-8 text-white">
        ...
        >
          ...
          <div class="flex gap-2 flex-1 justify-end">
            <p>
              H:
              {{ (((Math.round(day.temp.max) - 32) * 5) / 9).toFixed(0) }}&deg;
            </p>
            <p>
              L:
              {{ (((Math.round(day.temp.min) - 32) * 5) / 9).toFixed(0) }}&deg;
            </p>
          </div>
        </div>
      </div>
