<template>
    <div class="flex flex-col flex-1">
      ...
      <div class="flex flex-col py-12 items-center">
        <animated-placeholder class="max-w-[300px] w-full mb-2" />
        <animated-placeholder class="max-w-[300px] w-full mb-12" />
        <animated-placeholder
          class="max-w-[300px] h-[100px] w-full mb-12"
        />
        <animated-placeholder class="max-w-[300px] w-full mb-8" />
        <animated-placeholder
